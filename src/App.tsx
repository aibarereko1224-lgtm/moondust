...
function App() {
  ...
  return (
    <div className="legacy-app">
      ...
      <LongReviewWritingSpace active={modal === 'long-review'} onClose={() => setModal('detail')} onSaved={handleLongReviewSaved} record={selectedRecord} userId={auth.session?.user.id ?? null} />
    </div>
  )
}
